...
from .views import UserRegisterView, VerifyOTPView, LoginView, UserProfileView, ForgotPasswordView, VerifyForgotPasswordOTPView, ResetPasswordView, home_page_view
