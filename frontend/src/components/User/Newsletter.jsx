...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
      ...
      h-12'>
        <input className='border border-gray-300 rounded-md h-full border-r-0 1200
        ...
        hover:bg-primary transition-all cursor-pointer rounded-md rounded-1-none' >Subscribe</button>
      </form>
    </div>
  )
}
