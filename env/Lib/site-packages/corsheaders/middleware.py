...
class CorsMiddleware:
    ...
    def add_response_headers(
        ...
        # print(origin,'this is the oriiiiiiiiiiiiiiiiiiiiii')
        if not origin:
            return response
        ...
        try:
            ...
            return response
        # print(conf.CORS_ALLOW_ALL_ORIGINS,'Akkkkkkkkkkkkkkkkkkkkkkkkk')
        ...
        if (
            ...
            # print(response, 'hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
            return response
        # print(conf.CORS_ALLOW_CREDENTIALS,'ghgggggggggggggggggggg')
